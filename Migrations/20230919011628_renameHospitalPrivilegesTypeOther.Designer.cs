...
namespace cred_system_back_end_app.Migrations
{
    ...
    [Migration("20230919011628_renameHospitalPrivilegesTypeOther")]
    partial class renameHospitalPrivilegesTypeOther
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationDocumentEntity", b =>
                {
                    b.Property<int>("CorporationId")
                        .HasColumnType("int");

                    b.Property<string>("DocumentLocationId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("AzureBlobFilename");
                    ...
                    b.HasKey("CorporationId", "DocumentLocationId");

                    b.HasIndex("DocumentLocationId")
                        .IsUnique();

                    b.ToTable("CorporationDocument");
                });
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.HospitalEntity", b =>
                {
                    ...
                    b.Property<string>("HospitalPrivilegesTypeOther")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.MalpracticeEntity", b =>
                {
                    ...
                    b.Property<string>("MalpracticeCarrierOther")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.ProfessionalLiabilityEntity", b =>
                {
                    ...
                    b.Property<string>("ProfessionalLiabilityCarrierOther")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.ProviderSpecialtyEntity", b =>
                {
                    ...
                    b.HasKey("ProviderId", "SpecialtyListId", "DocumentLocationId");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.ProviderSubSpecialtyEntity", b =>
                {
                    ...
                    b.HasKey("ProviderId", "SubSpecialtyListId", "DocumentLocationId");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationDocumentEntity", b =>
                {
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationEntity", "Corporation")
                        .WithMany("CorporationDocument")
                        .HasForeignKey("CorporationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.DocumentLocationEntity", "DocumentLocation")
                        .WithOne("CorporationDocument")
                        .HasForeignKey("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationDocumentEntity", "DocumentLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.ProviderSpecialtyEntity", b =>
                {
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.DocumentLocationEntity", "DocumentLocation")
                        .WithOne("ProviderSpecialty")
                        .HasForeignKey("cred_system_back_end_app.Infrastructure.DB.Entity.ProviderSpecialtyEntity", "DocumentLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.ProviderSubSpecialtyEntity", b =>
                {
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.DocumentLocationEntity", "DocumentLocation")
                        .WithOne("ProviderSubSpecialty")
                        .HasForeignKey("cred_system_back_end_app.Infrastructure.DB.Entity.ProviderSubSpecialtyEntity", "DocumentLocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationEntity", b =>
                {
                    b.Navigation("CorporationDocument");
