...
namespace cred_system_back_end_app.Migrations
{
    ...
    [Migration("20230911213333_updateMedicalLicenseTypeListString")]
    partial class updateMedicalLicenseTypeListString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationSubSpecialtyEntity", b =>
                {
                    ...
                    b.Property<int?>("SubSpecialtyListEntityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubSpecialtyListEntityId");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.EducationTypeEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.MedicalGroupEntity", b =>
                {
                    ...
                    b.Property<int>("PcpSpecialtyId")
                        .HasColumnType("int");

                    b.Property<string>("SpecialistInput")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.CorporationSubSpecialtyEntity", b =>
                {
                    ...
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.SubSpecialtyListEntity", null)
                        .WithMany("CorporationSubSpecialty")
                        .HasForeignKey("SubSpecialtyListEntityId");
                });
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.EducationInfoEntity", b =>
                {
                    ...
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.EducationTypeEntity", "EducationType")
