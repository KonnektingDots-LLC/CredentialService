...
namespace cred_system_back_end_app.Migrations
{
    ...
    [Migration("20230905224151_CreateMedicalGroupTables")]
    partial class CreateMedicalGroupTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EducationInfoEntityProviderEntity", b =>
                {
                    ...
                    b.HasKey("EducationInfoId", "ProvidersId");
            ...
            modelBuilder.Entity("MedicalGroupEntityProviderEntity", b =>
                {
                    ...
                    b.HasKey("MedicalGroupId", "ProviderId");

                    b.HasIndex("ProviderId");

                    b.ToTable("MedicalGroupEntityProviderEntity");
                });

            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.AddressContactEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("AddressContactEmail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AddressContactFullName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AddressContactPhoneNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.AddressPlanAcceptListEntity", b =>
                {
                    ...
                    b.Property<string>("AddressPlanAcceptListCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AddressPlanAcceptListName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.MalpracticeEntity", b =>
                {
                    ...
                    b.Property<int>("InsuranceCarrierId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedicalGroupEntityProviderEntity", b =>
                {
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.MedicalGroupEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.MalpracticeEntity", b =>
                {
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.InsuranceCarrierListEntity", "InsuranceCarrier")
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.InsuranceCarrierListEntity", b =>
                {
                    ...
                    b.Navigation("ProfessionalLiabilty");
                });
