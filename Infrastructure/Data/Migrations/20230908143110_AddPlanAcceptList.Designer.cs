...
namespace cred_system_back_end_app.Migrations
{
    ...
    [Migration("20230908143110_AddPlanAcceptList")]
    partial class AddPlanAcceptList
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.PlanAcceptListEntity", b =>
                {
                    ...
                    b.Property<int?>("PlanAcceptListEntityId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("PlanAcceptListEntityId");
            ...
            modelBuilder.Entity("cred_system_back_end_app.Infrastructure.DB.Entity.PlanAcceptListEntity", b =>
                {
                    b.HasOne("cred_system_back_end_app.Infrastructure.DB.Entity.PlanAcceptListEntity", null)
                        .WithMany("PlanAcceptList")
                        .HasForeignKey("PlanAcceptListEntityId");
                });
